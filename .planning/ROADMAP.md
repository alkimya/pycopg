...
- 🟡 **v0.4.0 Quality & Spatial Helpers** — Phases 9-15 — *proposé, en attente de validation*

## Phases

### 🟡 v0.4.0 Quality & Spatial Helpers (Phases 9-15) — PROPOSÉ
...
| 9. Migration uv (outillage) | v0.4.0 | 0/? | Proposé | — |
| 10. Sécurité résiduelle & robustesse | v0.4.0 | 0/? | Proposé | — |
| 11. Parité sync/async complète | v0.4.0 | 0/? | Proposé | — |
| 12. Refactoring (base.py + queries.py) | v0.4.0 | 0/? | Proposé | — |
| 13. Qualité documentaire (numpydoc + interrogate) | v0.4.0 | 0/? | Proposé | — |
| 14. Spatial helpers (db.spatial.*) | v0.4.0 | 0/? | Proposé | — |
| 15. Release v0.4.0 (PyPI + RTD) | v0.4.0 | 0/? | Proposé | — |
